  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full p-4">
      ...
      <div className="col-span-1 md:col-span-2 grid grid-cols-5 gap-4 mb-4">
        ...
        <div className="bg-slate-800 p-4 rounded-lg shadow border border-slate-700">
          <h3 className="text-slate-400 text-sm font-semibold">物价指数 (CPI)</h3>
        ...
        <div className="bg-slate-800 p-4 rounded-lg shadow border border-slate-700">
          <h3 className="text-slate-400 text-sm font-semibold">存活企业数</h3>
      ...
      <div className="bg-slate-900 p-4 rounded-lg border border-slate-800 h-64">
        <h4 className="text-white mb-2 font-medium">宏观趋势: GDP 与 货币供应</h4>
      ...
      <div className="bg-slate-900 p-4 rounded-lg border border-slate-800 h-64">
        <h4 className="text-white mb-2 font-medium">菲利普斯曲线: 通胀与失业</h4>
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={data}>
            <CartesianGrid strokeDasharray="3 3" stroke="#334155" />
            <XAxis dataKey="tick" stroke="#94a3b8" />
            ...
            <Tooltip 
              ...
              formatter={(value: number, name: string) => [
                ...
                name === 'unemploymentRate' ? '失业率' : 'CPI (物价)'
              ]}
              labelFormatter={(label) => `Tick: ${label}`}
            />
